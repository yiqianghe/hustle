...
class CollegeOrg(models.Model):
    ...
    image = models.ImageField(upload_to="college_org/%Y/%m", verbose_name="学院logo", null=True, blank=True)
...
class Teacher(models.Model):
    ...
    click_nums = models.IntegerField(default=0, verbose_name="点击数")
    fav_nums = models.IntegerField(default=0, verbose_name="收藏数")
    image = models.ImageField(upload_to="teacher/%Y/%m", verbose_name="讲师封面", null=True, blank=True)
    add_time = models.DateTimeField(default=datetime.now)
